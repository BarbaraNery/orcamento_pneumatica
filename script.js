...
function gerarPDFManutencao() {
  ...
  criarCanhotoManutencao(doc, 210, numeroOrcamento, hoje, empresa, tipoEquipamento);
  criarCanhotoManutencao(doc, 255, numeroOrcamento, hoje, empresa, tipoEquipamento);
